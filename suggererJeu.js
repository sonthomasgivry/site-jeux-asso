...
export default async function handler(req, res) {
    ...
    // Image de secours propre et stable
    ...
    try {
        ...
        - "image": l'URL directe d'une image de la boîte du jeu (doit commencer par http et se terminer par .jpg ou .png si possible, évite les liens trop complexes). 
        ...
        if (geminiRes.ok) {
            ...
            // Validation stricte de l'URL pour Notion
            if (stats.image && stats.image.startsWith('http') && stats.image.length < 500) {
                infoJeu.image = stats.image;
            }
            
            console.log("✅ Stats et image IA récupérées avec succès :", infoJeu.image);
        } else {
