...
export default async function handler(req, res) {
    ...
    // Le navigateur de l'utilisateur a déjà fait le travail sur BGG !
    // Il nous envoie les informations prêtes à être enregistrées.
    ...
    try {
        ...
        if (!notionRes.ok) {
            ...
            return res.status(500).json({ error: "Erreur lors de la création dans Notion." });
        }
